...
const FileUploader = ({ selectedApplicant }) => {
  ...
  return (
    <VStack width="70%" height="50%" mt="20px">
      ...
      <Alert status="warning" minHeight="100px" borderRadius="10px" p="20px" mb="4" fontSize="16px">
        <AlertIcon />
        <AlertDescription>
      ...
      >
        <input {...getInputProps()} />
        <Icon as={DownloadIcon} w="200px" h="40px" mt="20px" mb="20px" color="gray.500" />
        <Text fontSize="20px">
